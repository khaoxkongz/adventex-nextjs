      ...
      <SheetContent className="space-y-4">
        ...
        <Accordion type="multiple" className="w-full" defaultValue={["1"]}>
          <AccordionItem value="1" className="py-2">
            ...
            <AccordionContent className="pb-2 text-muted-foreground">
              <div className="space-y-4">
                <RadioGroup
                  defaultValue="all"
                  onValueChange={(value: ProgramType | "all") => setFilters({ ...filters, type: value })}
                >
          ...
          <AccordionItem value="2" className="py-2">
            ...
            <AccordionContent className="pb-2 text-muted-foreground">
              <div className="space-y-4">
                <RadioGroup defaultValue="all" onValueChange={(value) => setFilters({ ...filters, university: value })}>
                  <div className="flex items-center space-x-2">
                  ...
                  >
                    {[
                      ...
                      <div key={index} className="flex items-center space-x-2">
                        <RadioGroupItem value={index.toString()} id={`radio-month-${index + 1}`} />
                        <Label
          ...
          <AccordionItem value="4" className="py-2">
            ...
            <AccordionContent className="pb-2 text-muted-foreground">
              <div className="space-y-4">
                <RadioGroup
                  defaultValue="all"
                  onValueChange={(value: Season) => setFilters({ ...filters, season: value })}
                >
                  <div className="flex items-center space-x-2">
                  ...
                  {Object.entries(seasonNames).map(([key, value]) => (
                    <div key={key} className="flex items-center space-x-2">
                      <RadioGroupItem value={value} id={`radio-season-${key}`} />
                      <Label
